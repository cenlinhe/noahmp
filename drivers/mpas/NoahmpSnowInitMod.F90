...
!------------------------------------------------------------------------------------------
    ...
    do I = its, ite
       ...
       if ( NoahmpIO%IOPT_ALB == 3 )then
          NoahmpIO%SNRDSXY(I,-NoahmpIO%NSNOW+1:0)  = 0.0
          NoahmpIO%SNFRXY (I,-NoahmpIO%NSNOW+1:0)  = 0.0
          NoahmpIO%BCPHIXY(I,-NoahmpIO%NSNOW+1:0)  = 0.0
          NoahmpIO%BCPHOXY(I,-NoahmpIO%NSNOW+1:0)  = 0.0
          NoahmpIO%OCPHIXY(I,-NoahmpIO%NSNOW+1:0)  = 0.0
          NoahmpIO%OCPHOXY(I,-NoahmpIO%NSNOW+1:0)  = 0.0
          NoahmpIO%DUST1XY(I,-NoahmpIO%NSNOW+1:0)  = 0.0
          NoahmpIO%DUST2XY(I,-NoahmpIO%NSNOW+1:0)  = 0.0
          NoahmpIO%DUST3XY(I,-NoahmpIO%NSNOW+1:0)  = 0.0
          NoahmpIO%DUST4XY(I,-NoahmpIO%NSNOW+1:0)  = 0.0
          NoahmpIO%DUST5XY(I,-NoahmpIO%NSNOW+1:0)  = 0.0
       endif
