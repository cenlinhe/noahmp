...
!------------------------------------------------------------------------
    ...
    real(kind=kind_noahmp), allocatable, dimension(:)      ::  T2MXY               ! 2m temperature grid mean [K]
    ...
    real(kind=kind_noahmp), allocatable, dimension(:)      ::  Q2MXY               ! 2m mixing ratio grid mean [kg/kg]
