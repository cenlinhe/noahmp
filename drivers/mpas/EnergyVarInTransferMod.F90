...
! -------------------------------------------------------------------------
    ...
    noahmp%energy%state%AlbedoSoilDir(1:NumSwRadBand)             = NoahmpIO%ALBSOILDIRXY(I,1:NumSwRadBand)
    noahmp%energy%state%AlbedoSoilDif(1:NumSwRadBand)             = NoahmpIO%ALBSOILDIFXY(I,1:NumSwRadBand)
