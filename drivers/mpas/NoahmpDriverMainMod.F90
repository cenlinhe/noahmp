...
! ------------------------------------------------------------------------- 
    ...
    if ( NoahmpIO%SOIL_UPDATE_STEPS == 1 ) then
       do I = NoahmpIO%ITS, NoahmpIO%ITE
          NoahmpIO%ACC_SSOILXY(I)    = 0.0
          NoahmpIO%ACC_QINSURXY(I)   = 0.0
          NoahmpIO%ACC_QSEVAXY(I)    = 0.0
          NoahmpIO%ACC_ETRANIXY(I,:) = 0.0
          NoahmpIO%ACC_DWATERXY(I)   = 0.0
          NoahmpIO%ACC_PRCPXY(I)     = 0.0
          NoahmpIO%ACC_ECANXY(I)     = 0.0
          NoahmpIO%ACC_ETRANXY(I)    = 0.0
          NoahmpIO%ACC_EDIRXY(I)     = 0.0
          NoahmpIO%ACC_GLAFLWXY(I)   = 0.0
       enddo
    endif
